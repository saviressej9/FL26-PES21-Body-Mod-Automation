# Assign-Sleeve.ps1
# Assigns players to a single sleeve variation folder.
# Used for both Sleeve Roll Up and Sleeve Inner grouped sections.
# Independent mod - no cross-exclusion with any other mod.
...
# ── execute ───────────────────────────────────────────────────────────────────
Write-Host ""
Write-Host ("===== SLEEVE ASSIGNMENT: {0} =====" -f (Split-Path -Leaf $RootPath)) -ForegroundColor Yellow
